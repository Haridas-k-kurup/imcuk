<?php
	...
	$timeObj		=	new DateTime($currentTime);
	$dateSent		=	$timeObj->format('F-d-Y');
	$showDate		=	$dateSent;
	$showTime		=	$timeObj->format('H:i A');
	$allType		=	$objConType->getAll('contact_type_status = 1','contact_type_id');
 ?>
<!--MAIN BODY START-->
...
<center><div class="ask_header">Contact Us</div></center><br/>


<div class="date_time_head">Date and Time</div>
<div class="time_displays">
<div class="col-lg-6"><center><?php echo $showDate; ?></center></div>
<div class="col-lg-6"><center><?php echo $showTime; ?></center></div>
</div>
<form action="<?php echo SITE_ROOT; ?>action.php?act=contactus" method="post" enctype="multipart/form-data">
<?php if ($sessionval) {
		$getName	= $objUser->getRow('reg_id = "'.$activeMem.'"');
 } ?>
<div class="date_time_head" style="margin-top:20px;">From</div>
<div class="time_displays" style="padding:10px 0px;">
<div class="col-lg-4">Name:</div>
<div class="col-lg-8"><div style="padding-bottom:10px;"><input type="text" required style="width:100%;border:2px solid #424447;" class="ask_table_inputs" value="<?php echo $getName['ud_first_name']; ?>" name="con_name" kl_virtual_keyboard_secure_input="on"></div></div>

<div class="col-lg-4">Email:</div>
<div class="col-lg-8"><input type="email" name="con_email" id="ask_email" required style="width:100%;border:2px solid #424447;" class="ask_table_inputs" value="<?php echo $getName['ud_email']; ?>" kl_virtual_keyboard_secure_input="on"></div>
<div class="clearfix"></div>
</div>


<div class="date_time_head" style="margin-top:20px;">Contact type</div>
<div class="time_displays" style="padding:10px 0px;">
<div class="col-lg-12">
 <?php foreach ($allType as $type) { ?>
<div align="left"><label> <input type="radio" required value="<?php echo $type['contact_type_id']; ?>" name="con_type"> <span  style="font-weight:normal;"> <?php echo $type['contact_type_name']; ?></span>
</label></div>
 <?php } ?>
</div>
<div class="clearfix"></div>
</div>
<div class="date_time_head" style="margin-top:20px;">Message</div>
<div class="time_displays" style="padding:10px 0px;">
<div class="col-lg-4">Subject:</div>
<div class="col-lg-8"><div style="padding-bottom:10px;"><input type="text" required style="width:100%;border:2px solid #424447;" class="ask_table_inputs" name="con_subject" id="ask_title" kl_virtual_keyboard_secure_input="on" placeholder="Enter subject"></div></div>

<div class="col-lg-12"><textarea placeholder="Write here..." style="width:100%; min-height:150px;" class="clear admin_add_content_textarea" name="con_msg"></textarea></div>

<div class="clearfix"></div>
</div>

<div style="padding:20px 0px;">
<div class="col-lg-6"><center><input type="reset" class="ask_buttons" value="Cancel" id="ask_preview" name="ask_preview" kl_virtual_keyboard_secure_input="on"></center></div>
<div class="col-lg-6"><center><input type="submit" class="ask_buttons" value="Submit" id="ask_preview" name="ask_preview" kl_virtual_keyboard_secure_input="on"></center></div>
</div>
</form>
<div class="clearfix"></div>
