...
<div class="container-fluid">
 ...
 <!--TOP SLIDER START-->
  <div class="row" style="padding:10px 0px;">
   ...
   <?php include_once('includes/user_profile_left.php'); ?>
    <div class="col-lg-9">
     <div class="row">
     <div class="col-lg-12">
     <div class="col-lg-9">
     <?php 
								 ...
								 ?>
     <span style="font-size:24px; color:#333;"><?php echo $mainName; ?></span> <a class="update-btn fr" id="compose" href="javascript:;">Message</a>
    ...
    <hr class="hrstyle3"/>
    <span class="textstylea1">Current (country of orgin):</span><br/><span class="textstylea2">  <?php echo stripslashes($userData['cur_town']); ?> <br> <?php echo stripslashes($userData['cur_city']); ?>  <br> <?php echo stripslashes($userData['cur_state']); ?> <br> <?php echo stripslashes($userData['cur_country']); ?><br><?php echo stripslashes($userData['cur_post_code']); ?>
    </span>
    </div></div>
    ...
    <div class="prof-more-dtils ovr">
        ...
        <?php 
				...
				//	$num_page_links_per_page 		= 	7;
					...
					$sql_pagination					.=	" where reg_id ='".$uId."' and topic_staff_manage = 0 and topic_status = 1 order by topic_id desc";
					...
					if ($page_list) {
					 ...
					 ?>
                            	<span class="proff-msg-btn1  topic-area"><a href="<?php echo SITE_ROOT; ?>forum_post.php?tid=<?php echo $topic['topic_id']; ?>"  title="VIEW"><i class="fa fa-eye"></i></a>
...
<div style="font-size:24px; color:#333;">Discussion</div>
        ...
        <?php 
				...
				//	$num_page_links_per_page 		= 	7;
					...
					$sql_pagination					.=	" where reg_id ='".$uId."' and dis_staff_manage = 0 and dis_status = 1 order by dis_id desc";
					...
					if ($page_list) { 
					 ...
					 ?>
                            	<span class="proff-msg-btn1  topic-area">
