...
class PHPSDKTestCase extends PHPUnit_Framework_TestCase {
  const APP_ID = '708286809285991';
  const SECRET = '4d2f2e0d9f4b5e159f7644538f8dbf43';

  const MIGRATED_APP_ID = '708286809285991';
  const MIGRATED_SECRET = '4d2f2e0d9f4b5e159f7644538f8dbf43';

  const TEST_USER   = 10202995208760881;
  const TEST_USER_2 = 10202995208760881;
