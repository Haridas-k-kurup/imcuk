...
if($_SESSION['reset-okay']	==	"success"){
	unset($_SESSION['reset-okay']);
?>
<!DOCTYPE html >
<html>
<head>
    	...
    	<div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
        	<div class="login-box loginBox clearfix animated flipInY">
                ...
                <div class="login-form">
                	<label class="email-head">Success! You've changed your password</label><br>
                        <button class="btn btn-login login-btn" style="width:100%;" type="button" onClick="parent.location='<?php echo SITE_ROOT; ?>'">Continue to IMC </button><br>
...
</html><?php }else{ header('location:'.SITE_ROOT);  }?>