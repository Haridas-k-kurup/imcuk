...
if($_SESSION['sent-info']	==	"sent"){
	unset($_SESSION['sent-info']);
?>
<!DOCTYPE html >
<html>
<head>
    	...
    	<div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
        	<div class="login-box loginBox clearfix animated flipInY">
                ...
                <div class="login-form">
                	<label class="email-head">We’ve sent you a link to change your password</label><br>
                    <span for="email" style="color:#060">We’ve sent you an email that will allow you to reset your password quickly and easily.</span><br>
                    
                        <button class="btn btn-login login-btn" style="width:100%;" type="button" onClick="parent.location='pssword-reset.php'">Email sent. Didn’t get it? </button>
...
<?php }else{ header('location:'.SITE_ROOT);  }?>