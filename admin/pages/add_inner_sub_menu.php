          ...
          <div class="row">
            ...
            <div class="form-group">
                ...
                <select class="form-control alert-danger" id="menu-cat">
                    ...
                    <option value="8">Top Menu ( Next to slider)</option>
            	...
            	<form action="" method="post" role="form" enctype="multipart/form-data" id="sub-menu-edit-field">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-group-btn">
                                        	...
                                        	<input type="text" class="form-control" id="menu_position" name="menu_position"  placeholder="Enter menu position...">
                                    </div>
                                        </div>
                                         </div>
                                    </div>
...
function addSubmenu(){ // for add sub menu for main menu
		...
		var position	=	$('#menu_position').val();
		var dataString	=	'subId='+sub_id+'&menu_name='+menu_name+'&menu_desc='+menu_desc+'&act=addsub'+'&position='+position;
		if(sub_id && menu_name){
...
function addSubSubmenu(){ // add sub sub menu for submeu
		...
		var dataString		=	'sub_menu_id='+sub_menu_id+'&menu_name='+menu_name+'&menu_desc='+menu_desc+'&act=addsubsub';
		if(sub_menu_id && menu_name){
			$('.img-preload').fadeIn(1000);
		$.ajax({
			type: "POST",
			url: "ajax_sub_action.php",
