                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                 <?php 
									echo $notfn->msg();
								?> 
                                <form action="<?php echo SITE_ROOT?>admin/action.php?act=manage_sub_sub_pluse" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-btn">
                                        	...
                                        	<input type="text" class="form-control" name="sub_pluse_menu[]" maxlength="15" required value="<?php echo $subPageDtail['topic']; ?>" placeholder="Enter Sub menu name or heading with in 10 character limit...">
                                    </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="input-group-btn">
                                        	...
                                        	<input type="number" class="form-control" name="sub_position[]" value="<?php echo $subPageDtail['position']; ?>" placeholder="Enter menu position">
                                    </div>
                                        </div>
                                        </div>  
                                        </div>
...
$('#sub_sub_menu').change(function(){ // chk where the select sub menu has alrady assigned sub sub menu or not
	...
	$.ajax({
	type: "POST",
	url: "ajax_sub_sub_menu_status.php",
	data: dataString,
	cache: false,
	success: function(data)
	{
