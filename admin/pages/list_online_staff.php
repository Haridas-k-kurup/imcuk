            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">List All Online Staffs</li>
                    </ol>
                </section>
                <!-- Main content -->
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">List All Online Staffs</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="row">
                                	<div class="col-lg-6">
...
$pg_param 									= 	"";
if($search){
	$sql_pagination 						= 	"SELECT * FROM admin where admin_type = 2 and admin_login_status = 1 order by admin_username asc";
}else{
	 $sql_pagination 						= 	"SELECT * FROM admin where admin_type = 2 and admin_login_status = 1 order by admin_username asc";
}
$pagesection								=	'';
...
?>                                     
                                            <tr>
                                                ...
                                                <td><?php echo $all['admin_editedon'];?></td>
                        ...
                        <a class="tiptip outer_admin_action" href="<?php echo SITE_ROOT; ?>admin/index.php?page=add_staff&staff=<?php echo $all['admin_id'];  ?>" title="Change User">
							<span class="inner_admin_action admin_action_delete"><i class="fa fa-pencil-square"></i></span>
                                     ...
                                     <?php } }else{ ?> 
                                     <tr>
                                                <td colspan="8">Sorry ! No Staff in Online</td>
                                                </tr>
                                     <?php } ?>  
                                      </tbody>
                                    </table>
