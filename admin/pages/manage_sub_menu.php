                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Add Sub-Sub Menu <small>( Here you can create Sub-sub of sub menu.  i.e : You should select MAIN MENU and its SUB-MENU, then go for add SUB-SUB MENU. )</small></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                 <?php 
									echo $notfn->msg();
								?> 
                                <form action="<?php echo SITE_ROOT?>admin/action.php?act=manage_sub_sub_pages" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <?php } ?>
                                    ...
                                    <div class="box-body">
                                    	<h4>Sub-Sub Menu Details<small> ( Add Sub-menu for above menu. Click on "Add New Sub-menu" button for add new Sub menu )</small></h4>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn-warning bg-maroon" type="button">Sub-sub Menu</button>
                                        </div><!-- /btn-group -->
                                        	<input type="text" class="form-control" name="sub_sub_menu[]" maxlength="15" required value="<?php echo $subPageDtail['topic']; ?>" placeholder="Enter Sub menu name or heading with in 10 character limit...">
                                    </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="input-group-btn">
                                        	...
                                        	<input type="number" class="form-control" name="sub_sub_position[]"  value="<?php echo $subPageDtail['position']; ?>" placeholder="Enter menu position">
                                    </div>
                                        </div>
                                        </div>  
                                        </div>
...
<script type="text/javascript" language="javascript">
$('#sub_menu').change(function(){ // chk where the select sub menu has alrady assigned sub sub menu or not
	var subMenuId	 	=	$(this).val();
	var dataString 		= 	'sub_menu_id='+subMenuId;
//alert("dataString=="+dataString);
	$.ajax({
	type: "POST",
	url: "ajax_sub_menu_status.php",
	data: dataString,
	cache: false,
	success: function(data)
	{	
		if(data == 1){ 
			if(confirm("Sorry ! You already added Sub-menu for this menu. For update or insert new sub menu go to MANAGE ALL MENU. Do you want to continue ?")){
