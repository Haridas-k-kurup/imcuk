            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Manage Menus <!--Sub-Categories--></li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Manage Menus <!--Sub-Categories --></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                 <?php 
									echo $notfn->msg();
                                ...
                                <form action="<?php echo SITE_ROOT?>admin/action.php?act=mng_sub_category" method="post" role="form" enctype="multipart/form-data">
                                    ...
                                    <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sub_name" placeholder="Enter menu name..." class="form-control" required value="<?php echo $getPage['subcat_name'];  ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Position</label>
                                            <input type="number" name="sub_position" placeholder="Enter menu position..." class="form-control" required value="<?php echo $getPage['subcat_position'];  ?>">
                                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">List Menus <!--Sub-Categories--></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                 ...
                                 <table class="table table-bordered table-hover" id="example2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="27%">Menu Name<!--Sub-Category--></th>
                                                <th width="5%">ID</th>
					...
					$pg_param 						= 	"";
					if($search){
						$sql_pagination 			= 	"SELECT subcat.subcat_id, subcat.subcat_name, subcat.subcat_position, subcat.subcat_status, cat.cat_id, cat.cat_category FROM manage_sub_category AS subcat LEFT JOIN manage_category AS cat ON subcat.cat_id = cat.cat_id WHERE subcat.subcat_id != 1 AND (subcat.subcat_name LIKE '%".$search."%' OR page.page_name LIKE '%".$search."%' OR cat.cat_category LIKE '%".$search."%') ORDER BY subcat.subcat_id DESC"; 
					}else{
						$sql_pagination 			= 	"SELECT subcat.subcat_id, subcat.subcat_name,  subcat.subcat_position, subcat.subcat_status, cat.cat_id, cat.cat_category FROM manage_sub_category AS subcat LEFT JOIN manage_category AS cat ON subcat.cat_id = cat.cat_id WHERE subcat.subcat_id != 1 ORDER BY subcat.subcat_id DESC";
					}
					$pagesection					=	'';
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo $all['subcat_position']; ?></td>
