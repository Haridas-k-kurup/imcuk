  ...
  <aside class="right-side"> 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage All Menu</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Edit Inner Menus <small> ( Click on menu, Sub-menu or Sub-sub menu for edit this  or delete content )</small></h3>
          ...
          <div class="row">
            ...
            <div class="box">
            	...
            	<form action="<?php echo SITE_ROOT?>admin/ajax_sub_action.php" method="post" role="form" enctype="multipart/form-data" id="sub-menu-edit-field">
...
function updateSubmenu(actionFlag){
	...
	if(id && flag){	
			var dataString 	= 	'id='+id+'&flag='+flag+'&actionFlag='+actionFlag+'&heading='+heading+'&desc='+editor_data+'&pos='+pos; 
		  //alert(dataString);
		  if(confirm(actDialog)){ 
			$.ajax({
			type: "POST",
			url: "ajax_sub_action.php",
			data: dataString,
			cache: false,
			async:false,
			success: function(data){  //alert(data);
