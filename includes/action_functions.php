<?php
	class notification_types{
		public function notification($rmsg,$n){
			...
			switch($n){
				case 1:
				$msg	=	"<div class=\"alert alert-info alert-dismissable\" ><p><strong>INFORMATION: </strong>".$rmsg."</p></div>";
				break;
				case 2:
				$msg	=	"<div class=\"alert alert-warning alert-dismissable\" style=\" color:#ad0800\"><p><strong>WARNING: </strong>".$rmsg."</p></div>";
				break;
				case 3:
				$msg	=	"<div class=\"alert alert-success alert-dismissable\"><p><strong>SUCCESS: </strong>".$rmsg."</p></div>";
				break;
				case 4:
				$msg	=	"<div class=\"alert alert-danger alert-dismissable\"><p><strong>FAILURE: </strong>".$rmsg."</p></div>";
				break;
				case 5:
